...
public final class FakeItems {
    ...
    public static final List<FakeItem> ALL = List.of(
            ...
            new EquippableCharmFakeItem(4, "Running Shoes",              Rarity.UNCOMMON, "running_shoes__charm",        EquipmentSlot.FEET,  new RunningShoesCharm(),       "Been there, run that.",               "Enhances the user's mobility."),
