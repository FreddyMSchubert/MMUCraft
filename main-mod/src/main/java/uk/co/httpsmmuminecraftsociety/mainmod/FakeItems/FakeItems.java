...
public final class FakeItems {
    ...
    public static final List<FakeItem> ALL = List.of(
            ...
            new EquippableCharmFakeItem(17, "Bunny Pajama Charm",         Rarity.UNCOMMON, "bunny_pajamas__charm",        EquipmentSlot.LEGS,  new BunnyPajamaCharm(),        "Perfect for some Eggsercise and Hareobics.", "You'll jump like LeBron and take less fall damage. The bunnies might also get a bit snacky."),
            new EquippableCharmFakeItem(18, "Kitty Pajama Charm",         Rarity.UNCOMMON, "kitty_pajamas__charm",        EquipmentSlot.LEGS,  new KittyPajamaCharm(),        "They look nice and purrple.",                "The wearer won't take fall damage and scare away creepers."),
            new EquippableCharmFakeItem(19, "Wall Climbing Charm",        Rarity.UNCOMMON, "wasdfasdf__charm",         EquipmentSlot.LEGS,  new WallClimbingCharm(),        "They look nice and purrple.",                "The wearer won't take fall damage and scare away creepers.")
    );
