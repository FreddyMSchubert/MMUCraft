									...
									<tr key={entry.email}>
										...
										<td>
											...
											entry.responsiblePlayerColor ? (
												<PlayerName
													...
													isCommittee={entry.responsibleIsCommittee}
													customEmojis={entry.responsibleCustomEmojis}
												/>
											) : (
										...
										<td>
											<PlayerName
												...
												isCommittee={entry.addedByIsCommittee}
												customEmojis={entry.addedByCustomEmojis}
											/>
										</td>
