...
To do so, find [our societies page on the union website](https://www.theunionmmu.org/groups/26-3-minecraft-society), and click on the "**Join this group**" button. The rest will become apparent.
...
- Permanent multiplier to dabloons payout earned from completing advancements. You also receive a one-time 100 Dabloons advancement reward for becoming a member (which, with the added membership multiplier, is actually 120 Dabloons).
...
- Ability to buy all of the items from the shop. (Many animated & dyeable ones are otherwise unavailable)
- Way more cool particles for particle trails than just the colored dust for your elytra, glider, bow, crossbow, trident and mace.
