...
export function SitePage({ children, className = '', contentClassName = '', overlay, background, splash }: {
	children: ReactNode
	className?: string
	...
	return <main className={`page ${className}`.trim()}>
		<div className="siteBackground" style={{ backgroundImage: `url(${background})` }} aria-hidden="true" />
		{overlay}
