...
public enum TrailParticle {
    ...
    RED_POPLAR_LEAVES(Items.RED_POPLAR_LEAVES, "Red poplar leaves", ParticleTypes.RED_POPLAR_LEAVES),
    ORANGE_POPLAR_LEAVES(Items.ORANGE_POPLAR_LEAVES, "Orange poplar leaves", ParticleTypes.ORANGE_POPLAR_LEAVES),
    YELLOW_POPLAR_LEAVES(Items.YELLOW_POPLAR_LEAVES, "Yellow poplar leaves", ParticleTypes.YELLOW_POPLAR_LEAVES),
