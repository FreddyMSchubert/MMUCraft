...
public class EnchantmentSettingsManager
{
    ...
    public static final List<EnchantmentSettings> enchantmentSettings = List.of(
        ...
        new EnchantmentSettings(Enchantments.UNBREAKING).maxLevels(-1, 3, 4).inLoottable("chests/end_city_treasure").rarity(Rarity.RARE).dupedWithVanillaItem(Items.TOTEM_OF_UNDYING),
        ...
        new EnchantmentSettings(Enchantments.DEPTH_STRIDER).maxLevels(-1, 3, 4).inLoottable("chests/underwater_ruin_big", "chests/underwater_ruin_small").rarity(Rarity.RARE).dupedWithVanillaItem(Items.PRISMARINE_SHARD, 3),
        new EnchantmentSettings(Enchantments.RESPIRATION).maxLevels(-1, 3, 4).inLoottable("chests/shipwreck_treasure", "chests/shipwreck_supply", "chests/shipwreck_map").rarity(Rarity.RARE).dupedWithVanillaItem(Items.TURTLE_HELMET),

        // general armour enchantments
        new EnchantmentSettings(Enchantments.FEATHER_FALLING).maxLevels(-1, 4, 5).inLoottable("chests/desert_pyramid").rarity(Rarity.UNCOMMON), // TODO: dupeability
        new EnchantmentSettings(Enchantments.THORNS).maxLevels(-1, 3, 4).inLoottable("chests/simple_dungeon").dupedWithVanillaItem(Items.CACTUS_FLOWER, 2),
        ...
        new EnchantmentSettings(Enchantments.PROTECTION).maxLevels(-1, 4, 5).inLoottable("chests/end_city_treasure").rarity(Rarity.EPIC).dupedWithVanillaItem(Items.ARMADILLO_SCUTE, 5),
        new EnchantmentSettings(Enchantments.BLAST_PROTECTION).maxLevels(1, 4, 5).dupedWithVanillaItem(Items.ARMADILLO_SCUTE, 3),
        new EnchantmentSettings(Enchantments.FIRE_PROTECTION).maxLevels(1, 4, 5).dupedWithVanillaItem(Items.ARMADILLO_SCUTE, 3),
        new EnchantmentSettings(Enchantments.PROJECTILE_PROTECTION).maxLevels(1, 4, 5).dupedWithVanillaItem(Items.ARMADILLO_SCUTE, 3),

        // mace enchantments
        new EnchantmentSettings(Enchantments.BREACH).maxLevels(-1, 4, 5).inLoottable(trialChamberRewards).rarity(Rarity.EPIC).dupedWithVanillaItem(Items.POINTED_DRIPSTONE, 10),
        new EnchantmentSettings(Enchantments.DENSITY).maxLevels(-1, 5, 6).inLoottable(trialChamberRewards).rarity(Rarity.EPIC).dupedWithVanillaItem(Items.ANVIL),
        new EnchantmentSettings(Enchantments.WIND_BURST).maxLevels(-1, 3, 4).inLoottable(trialChamberRewards).rarity(Rarity.EPIC).dupedWithVanillaItem(Items.BREEZE_ROD, 3),
        ...
        new EnchantmentSettings(Enchantments.CHANNELING).maxLevels(-1, 1, 1).inLoottable("entities/zombie_nautilus").dupedWithVanillaItem(Items.WAXED_OXIDIZED_LIGHTNING_ROD),
        new EnchantmentSettings(Enchantments.IMPALING).maxLevels(-1, 5, 6).inLoottable("entities/zombie_nautilus").dupedWithVanillaItem(Items.NAUTILUS_SHELL),
        new EnchantmentSettings(Enchantments.LOYALTY).maxLevels(-1, 3, 4).inLoottable("entities/drowned").rarity(Rarity.EPIC), // TODO: duped by dog collar from killing a tamed dog
        new EnchantmentSettings(Enchantments.RIPTIDE).maxLevels(-1, 3, 4).inLoottable("entities/drowned").rarity(Rarity.EPIC).dupedWithVanillaItem(Items.PHANTOM_MEMBRANE, 3),

        // tool enchantments
        new EnchantmentSettings(Enchantments.EFFICIENCY).maxLevels(-1, 5, 6).inLoottable("chests/stronghold_corridor", "chests/stronghold_crossing", "chests/stronghold_library").rarity(Rarity.RARE).dupedWithVanillaItem(Items.TNT),
        ...
        new EnchantmentSettings(Enchantments.LOOTING).maxLevels(-1, 3, 4).inLoottable("chests/nether_bridge").rarity(Rarity.RARE), // TODO: deupeability
        new EnchantmentSettings(Enchantments.FIRE_ASPECT).maxLevels(-1, 2, 3).inLoottable("chests/ruined_portal").rarity(Rarity.UNCOMMON).dupedWithVanillaItem(Items.FIRE_CHARGE),
        ...
        new EnchantmentSettings(Enchantments.SHARPNESS).maxLevels(1, 5, 6).rarity(Rarity.EPIC), // TODO: dupeability
        new EnchantmentSettings(Enchantments.SWEEPING_EDGE).maxLevels(-1, 3, 4).inLoottable("chests/woodland_mansion"), // TODO: dupeability
        new EnchantmentSettings(Enchantments.SMITE).maxLevels(1, 5, 6).dupedWithVanillaItem(Items.NETHER_STAR),
        new EnchantmentSettings(Enchantments.BANE_OF_ARTHROPODS).maxLevels(1, 5, 6).dupedWithVanillaItem(Items.FERMENTED_SPIDER_EYE, 5),
        new EnchantmentSettings(Enchantments.LUNGE).maxLevels(-1, 3, 4).inLoottable("chests/desert_pyramid").rarity(Rarity.RARE), // TODO: dupeability
        ...
        new EnchantmentSettings(Enchantments.SOUL_SPEED).maxLevels(-1, 3, 4).inLoottable(bastionRewards).rarity(Rarity.RARE).dupedWithVanillaItem(Items.GILDED_BLACKSTONE, 3),
        ...
        new EnchantmentSettings(Enchantments.POWER).maxLevels(-1, 5, 6).inLoottable(bastionRewards).rarity(Rarity.RARE), // TODO: dupeability
        new EnchantmentSettings(Enchantments.PUNCH).maxLevels(-1, 2, 3).inLoottable("chests/jungle_temple").rarity(Rarity.UNCOMMON), // TODO: dupeability
        ...
        new EnchantmentSettings(Enchantments.LUCK_OF_THE_SEA).maxLevels(-1, 3, 4).inLoottable("chests/buried_treasure"), // TODO: dupeability
        new EnchantmentSettings(Enchantments.LURE).maxLevels(-1, 3, 4), // TODO: From fishing // TODO: dupeability

        // crossbow enchantments
        new EnchantmentSettings(Enchantments.MULTISHOT).maxLevels(-1, 1, 1).inLoottable("chests/pillager_outpost"), // TODO: dupeability
        new EnchantmentSettings(Enchantments.PIERCING).maxLevels(-1, 4, 5).inLoottable("chests/pillager_outpost"), // TODO: dupeability
        new EnchantmentSettings(Enchantments.QUICK_CHARGE).maxLevels(-1, 3, 4).inLoottable("chests/pillager_outpost").dupedWithVanillaItem(Items.FIREWORK_STAR),
    ...
    public static int getMaxAnvilLevel(Holder<Enchantment> enchantment, ItemStack stack) {
        return getSettingsForEnch(enchantment)
                ...
                .orElse(enchantment.value().getMaxLevel());
    }
