...
public final class FakeItems {
    ...
    public static final List<FakeItem> ALL = List.of(
            ...
            new EquippableCharmFakeItem(3,  "Heart on your Sleeve Charm", Rarity.UNCOMMON, "heart_sleeve__charm",         EquipmentSlot.CHEST, new HeartCharm(0),        "Blessed be the pacemakers",           "Grants the user extra life."),
            ...
            new EquippableCharmFakeItem(5,  "Heart of Diamond Charm",     Rarity.UNCOMMON, "heart_diamond__charm",        EquipmentSlot.CHEST, new HeartCharm(2),        "Blessed be the pacemakers",           "Grants the user significantly more extra life."),
            new EquippableCharmFakeItem(6,  "Heart of Netherite Charm",   Rarity.UNCOMMON, "heart_netherite__charm",      EquipmentSlot.CHEST, new HeartCharm(3),        "Blessed be the pacemakers",           "Grants the user a stupidly unbalanced amount of extra life."),
