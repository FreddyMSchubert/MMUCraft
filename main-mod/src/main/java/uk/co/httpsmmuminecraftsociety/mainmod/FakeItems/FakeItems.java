...
public final class FakeItems {
    ...
    public static final List<FakeItem> ALL = List.of(
            ...
            new EquippableCharmFakeItem(17, "Bunny Pajama Charm",         Rarity.UNCOMMON, "bunny_pajama__charm",         EquipmentSlot.LEGS,  new BunnyPajamaCharm(),        "Perfect for some Eggsercise and Hareobics.", "You'll jump like LeBron and take less fall damage."),
            new EquippableCharmFakeItem(18, "Kitty Pajama Charm",         Rarity.UNCOMMON, "kitty_pajama__charm",         EquipmentSlot.LEGS,  new KittyPajamaCharm(),        "They look nice and purrple.",                "The wearer won't take fall damage and scare away creepers.")
    );
