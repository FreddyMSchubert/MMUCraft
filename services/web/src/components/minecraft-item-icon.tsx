...
export function MinecraftItemIcon({ className, itemId, modelUrl, textureUrl }: MinecraftItemIconProps) {
	...
	return <div ref={hostRef} aria-hidden="true" className={`${className}${failed ? ' minecraftItemIconFailed' : ''}`} />
}
