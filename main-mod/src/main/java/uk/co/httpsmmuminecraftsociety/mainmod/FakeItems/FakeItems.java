...
public final class FakeItems {
    ...
    public static final List<FakeItem> ALL = List.of(
            ...
            new EquippableCharmFakeItem(16, "Extendo Grip Charm",         Rarity.UNCOMMON, "extendo_grip__charm",         EquipmentSlot.CHEST, new ExtendoGripCharm(),        "Saves you a round trip to turkey.",      "Stretches your in a very humane way.")
    );
