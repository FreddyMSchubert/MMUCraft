...
const TYPE_OPTIONS: { value: 'all' | ShopItemType; label: string }[] = [
	{ value: 'all', label: 'All' },
...
const TAG_OPTIONS: { value: ShopTagFilter; label: string }[] = [
	{ value: 'all', label: 'All' },
...
const ORDER_OPTIONS: { value: ShopOrder; label: string }[] = [
...
function formatDabloons(value: number) {
	return value.toLocaleString('en-US');
}
function shouldHidePreview(item: ShopItem, arachnophobiaMode: boolean) {
...
function compareTitles(left: ShopItem, right: ShopItem) {
	return left.title.localeCompare(right.title, 'en');
}
function rarityRank(item: ShopItem) {
