...
public class ModItemTagProvider extends FabricTagsProvider.ItemTagsProvider
{
    ...
    protected void addTags(HolderLookup.Provider provider)
    {
        ...
        builder(CHARM_DROPPING_CHESTS_HAVE_ITEMS)
            ...
            // Music discs / collectible treasure
            ...
            // High-value resource jackpots
            .add(key(Items.DIAMOND))
            .add(key(Items.DIAMOND_BLOCK))
            .add(key(Items.EMERALD_BLOCK))
            ...
            // Rare structure collectibles
            .add(key(Items.FLOW_BANNER_PATTERN))
            .add(key(Items.GUSTER_BANNER_PATTERN));
