...
CREATE TABLE `__new_claims` (
	...
	CONSTRAINT "claims_is_server_check" CHECK("__new_claims"."is_server" in (0, 1))
);
--> statement-breakpoint
INSERT INTO `__new_claims`("id", "owner_user_id", "dimension", "chunk_x", "chunk_z", "claim_name", "color_hex", "created_at_unix_ms") SELECT "id", "owner_user_id", "dimension", "chunk_x", "chunk_z", "claim_name", "color_hex", "created_at_unix_ms" FROM `claims`;--> statement-breakpoint
